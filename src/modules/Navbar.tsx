...
const Navbar: React.FC = () => {
  ...
  <div className="flex-grow hover:underline">
    <p className="font-cedarville lg:text-5xl md:text-3xl">
      Anns Lodge
    </p>
  </div>
  <div className=" hover:text-rose-600 sm:relative top-12 right-28 sm:right-18">
  ...
  <div className="ml-auto">
    <button
      className="font-montserrat bg-blue-500 hover:bg-blue-700 hover:font-extrabold lg:text-2xl md:text-md sm:text-sm text-white font-bold py-2 px-2 mt-4"
      onClick={() =>
